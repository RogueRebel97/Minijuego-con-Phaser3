...
public signin<UserModel>(username:string, password:string){
  ...
  return this.http.post("http://localhost/backend/user/post.php", {nombre:username, password:password});
...
return this.http.post("http://localhost/backend/user/usernameCheck.php", {nombre:username});
